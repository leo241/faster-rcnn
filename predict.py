...
if __name__ == '__main__':
    ...
    original_img = Image.open(r'C:\Users\86153\Desktop\hw2_v2\voctest\VOCdevkit\VOC2007\JPEGImages\000002.jpg')
    font_size = 10
    line_size = 3
    ...
    with torch.no_grad():
        ...
        # import numpy as np
        # plot_img2 = draw_objs(original_img,
        #                       np.asarray([[0, 364, 857, 2134], [864, 486, 1600, 2134]]),
        #                       predict_classes[0:2],
        #                       np.asarray([1, 1]),
        #                       category_index=category_index,
        #                       box_thresh=0.5,
        ...
        # plot_img2 = draw_objs(original_img,
        #                       np.asarray([[141 ,247 ,1426 ,1032], [476 ,345 ,801 ,644]]),
        #                       np.asarray([2,7]),
        #                       np.asarray([1, 1]),
        #                       category_index=category_index,
        #                       box_thresh=0.5,
